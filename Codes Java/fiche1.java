...
public class fiche1 {
	 public static void fiche1xml(final String txtFile) throws Exception {
	        ...
	        while ((ligne = br.readLine()) != null) {
	            ...
	            if (counter >= 0 & counter <= 21) {
	                ...
	                if ((counter >= 0 & counter <= 1) | counter == 4) {
	                    ...
	                    Element ele2 = doc.createElement(h);
	                    rac.appendChild(ele2);
	                    ele1.appendChild(ele2);
	                    lang.appendChild(ele2);
	                    ele2.appendChild(doc.createTextNode(String.valueOf(h2) + " : " + medecin));
	                    ele2 = doc.createElement(h2);
	                    rac.appendChild(ele2);
	                    ele1.appendChild(ele2);
	                    lang.appendChild(ele2);
	                    ele2.appendChild(doc.createTextNode(String.valueOf(h) + " : " + auteur));
	                }
	                ...
	                if ((counter >= 29 & counter <= 30) | counter == 33) {
	                    final Element ele2 = doc.createElement(balise);
	                    rac.appendChild(ele2);
	                    ele1.appendChild(ele2);
	                    if (counter == 29) {
	                ...
	                if ((counter >= 54 & counter <= 55) | counter == 58) {
	                    final Element ele2 = doc.createElement(balise);
	                    rac.appendChild(ele2);
	                    ele1.appendChild(ele2);
	                    if (counter == 53) {
	                ...
	                if ((counter >= 79 & counter <= 80) | counter == 83) {
	                    final Element ele2 = doc.createElement(balise);
	                    rac.appendChild(ele2);
	                    ele1.appendChild(ele2);
	                    if (counter == 79) {
	        ...
	        final StreamResult res = new StreamResult(new File("fiches1.xml"));
	        ...
	        tr.transform(ds, res);
	        System.out.println("Le fichier fiches.txt est transforme avec succes \"fiches1.xml\" ");
	    }
